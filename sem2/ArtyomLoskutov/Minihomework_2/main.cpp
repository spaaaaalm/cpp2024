...
int main() {
    ...
    textHp.setFillColor(sf::Color::Blue);
    ...
    sf::RectangleShape shapes[CELLSIZE_W][CELLSIZE_H];
    sf::Texture textures[TextureType::Texture_End];
    textures[TextureType::Texture_Grass] = sf::Texture("res/grass.png");
    textures[TextureType::Texture_Hill] = sf::Texture("res/hill.png");
    textures[TextureType::Texture_Forest] = sf::Texture("res/forest.png");
    textures[TextureType::Texture_Stone] = sf::Texture("res/stone.png");
    textures[TextureType::Texture_Sand] = sf::Texture("res/sand.png");
    textures[TextureType::Texture_Snow] = sf::Texture("res/snow.png");
    textures[TextureType::Texture_Water] = sf::Texture("res/water.png");
    textures[TextureType::Texture_Hide] = sf::Texture("res/hide.png");
    textures[TextureType::Texture_Soup] = sf::Texture("res/soup.png");
    textures[TextureType::Texture_Monster] = sf::Texture("res/monster.png");
